        ...
        <div class="gridtong">
            ...
            <form method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="<?=$data['pemilik_mobil']?>" placeholder="Nama-NIM" name="Nama_Pem" class="form-control" id="Uname1">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="Desc" value="" placeholder="Kita disini menjaga sesama perasaan seluruh kustomer kami" id="exampleFormControlTextarea1" rows="3"><?=$data['deskripsi']?></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="statusbayar" value="lunas" <?php echo $data['status_pembayaran'] == 'lunas' ? 'checked' : '' ?> <?php echo $data['status_pembayaran'] == 'belum lunas' ? 'disabled' : '' ?>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="statusbayar" id="flexRadioDefault2" value="belum lunas" <?php echo $data['status_pembayaran'] == 'belum lunas' ? 'checked' : '' ?> <?php echo $data['status_pembayaran'] == 'lunas' ? 'disabled' : '' ?>>
                        <label class="form-check-label" for="flexRadioDefault2">
                            Belum Lunas
                        </label>
                    </div>
                        <a href="Kemal_index.php?page=edit&id=<?= $data['id_mobil'] ?>" class="btn btn-primary booking-cta">Edit</a>
                    </div>
