...
include 'Connector.php';
 ...
 if (isset($_POST['edit'])) {
    ...
    if ($file_tmp) {
        ...
        $query = "UPDATE showroom_kemal_table SET nama_mobil = '$namaMob', pemilik_mobil = '$date', merk_mobil = '$brand', tanggal_beli = '$tanggal_beli', deskripsi = '$description', foto_mobil = '$file', status_pembayaran = '$status' WHERE id_mobil = $id";
